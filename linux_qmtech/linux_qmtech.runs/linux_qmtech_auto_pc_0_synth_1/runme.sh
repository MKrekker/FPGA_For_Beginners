...
HD_PWD='/home/mkrekker/Documents/FPGA_For_Beginners/linux_qmtech/linux_qmtech.runs/linux_qmtech_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log linux_qmtech_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source linux_qmtech_auto_pc_0.tcl
