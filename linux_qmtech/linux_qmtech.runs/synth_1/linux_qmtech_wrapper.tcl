...
synth_design -top linux_qmtech_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef linux_qmtech_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file linux_qmtech_wrapper_utilization_synth.rpt -pb linux_qmtech_wrapper_utilization_synth.pb"
