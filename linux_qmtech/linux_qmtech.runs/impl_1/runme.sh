...
HD_PWD='/home/mkrekker/Documents/FPGA_For_Beginners/linux_qmtech/linux_qmtech.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log linux_qmtech_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source linux_qmtech_wrapper.tcl -notrace
