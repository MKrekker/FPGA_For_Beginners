...
HD_PWD='/home/krekker/spi_adc/spi_adc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_test_mcs3201.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_test_mcs3201.tcl
