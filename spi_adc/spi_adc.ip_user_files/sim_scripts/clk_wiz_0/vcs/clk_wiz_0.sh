...
#
# Generated by Vivado on Sat Nov 06 15:27:44 CET 2021
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2019.1.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../spi_adc.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../spi_adc.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
